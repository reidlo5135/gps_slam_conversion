...
static constexpr const char *RCL_VIRTUAL_MAP_LT_POINT_LON_PARAMETER = "virtual_lt_point_lon";
static constexpr const char *RCL_VIRTUAL_MAP_LT_POINT_LAT_PARAMETER = "virtual_lt_point_lat";
...
static constexpr const char *RCL_SLAM_PIXELS_CONVETER_SERVICE_SERVER_NANE = "/gps_slam_conveter/pixels_conversion";
static constexpr const char *RCL_GTS_CONVERTER_SERVICE_SERVER_NAME = "/gps_slam_converter/conversion";
static constexpr const char *RCL_GTS_CONVERTER_SERVICE_CONVERSION_TARGET_GPS = "GPS";
static constexpr const char *RCL_GTS_CONVERTER_SERVICE_CONVERSION_TARGET_SLAM = "SLAM";
